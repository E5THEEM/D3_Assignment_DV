...
var valueline2 = d3.line()
    .x(function(d) { return x(d.Year); })
    .y(function(d) { return y1(d.Forest); });
...
// Get the data
d3.csv("../Datasets/WorldPopulation&DeforestationForestArea.csv", function(error, data) {
  ...
  y1.domain([0, d3.max(data, function(d) {return Math.max(d.Forest); })]);
...
//mouseover and dots
      ...
      .attr("r", 4)		
      .attr("cx", function(d) { return x(d.Year); })		 
      .attr("cy", function(d) { return y1(d.Forest); })
      .style("fill", "red" )	
      ...
      .on("mouseover", function(d) {		
          div.transition()		
              .duration(200)		
              .style("opacity", .9);		
          div	.html(formatTime(d.Year) + "<br/>"  + (d.Forest + " %"))
              .style("left", (d3.event.pageX) + "px")		
              .style("top", (d3.event.pageY - 28) + "px");	
          })					
      .on("mouseout", function(d) {		
